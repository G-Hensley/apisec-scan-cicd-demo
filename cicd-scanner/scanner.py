...
USER_AGENT = "apisec-cicd/5.1.2.1-fix3"
CONNECT_TIMEOUT = 10
READ_TIMEOUT = 60
...
class Scanner:
    ...
    def init(self):
        body = {"scanWithAuthId": self.scan_config.authentication_id or ""}
        url = f"{self.scan_config.apisec_base_url}/v1/applications/{self.scan_config.application_id}/instances/{self.scan_config.instance_id}/scan"
